...
Package "ironic": 
[RUNNING] "ghcr.io/kptdev/krm-functions-catalog/set-image:v0.1.1"
[PASS] "ghcr.io/kptdev/krm-functions-catalog/set-image:v0.1.1" in 400ms
  Results:
    ...
    [info] apps/v1/Deployment/baremetal-operator-system/baremetal-operator-ironic spec.template.spec.containers.image: set image from quay.io/metal3-io/ironic to quay.io/metal3-io/ironic:v29.0.0
[RUNNING] "ghcr.io/kptdev/krm-functions-catalog/set-image:v0.1.1"
[PASS] "ghcr.io/kptdev/krm-functions-catalog/set-image:v0.1.1" in 300ms
  Results:
